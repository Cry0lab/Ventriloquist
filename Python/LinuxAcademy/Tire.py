...
class Tire:
    ...
    def _side_wall_inches(self): #underscore designates a method internal to the class. Still publically accessible, but not advertised.
...
class SnowTire(Tire):
    def __init__(self, tire_type, width, ratio, diameter, chain_thickness, brand='', construction='R'):
             super().__init__(self, tire_type, width, ratio, diameter, brand='', construction='R')
